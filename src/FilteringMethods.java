...
public class FilteringMethods {
    ...
    public FilteringMethods(Set<Notebook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public FilteringMethods(Set<Notebook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public Map<String, String> descriptionsProperties(){
        ...
        map.put("name", "Название модели");
        map.put("RAM", "Объем оперативной памяти");
        map.put("HDD", "Жёсткий диск");
